...
const Page = () => {
 ...
 const [Input,setInput]=useState("")
  const handleGrammarClick = () => {
    setTriggerGrammarCheck(true); // Set triggerGrammarCheck to true to initiate grammar check
  };
            ...
            <form action="" className="height-[800px]">
              <div className="flex flex-col w-full items-center gap-8 h-96">
                ...
                <div className="h-[800px] rounded-full">
                  <SimpleEditor triggerGrammarCheck={triggerGrammarCheck} title={Input} taskType={taskType} />
                </div>
                <div className="h-28">
