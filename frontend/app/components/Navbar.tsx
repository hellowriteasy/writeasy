...
const Navbar: React.FC<NavbarProps> = ({ titles }) => {
  ...
  if (
    ...
    return null; // Return null or a placeholder when rendering on the server
  }
  ...
  return (
    <nav className="navbar flex w-screen sticky top-0 h-28 justify-between items-center bg-custom-yellow p-6 z-50">
      {navContent}
      <div
        className={`fixed top-0 left-0 h-full bg-custom-yellow p-4 flex flex-col items-center space-y-4 z-50 transform ${
          ...
          {loggedIn ? (
            ...
            <>
              <button
                ...
                className="text-lg sm:text-2xl font-bold text-center bg-custom-yellow border-2 w-32 h-12 hover:bg-white rounded-3xl border-black text-black font-comic"
              >
                Login
              </button>
              <button
                ...
                className="text-lg sm:text-2xl font-bold text-center bg-black border-2 w-32 h-12 rounded-3xl hover:opacity-80 border-black text-white font-comic"
              >
                Sign up
              </button>
            </>
