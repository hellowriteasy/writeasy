  ...
  <html dir="ltr" lang="en">
    ...
    <body class="" style="margin-left:auto;margin-right:auto;font-family:ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, &quot;Helvetica Neue&quot;, Arial, &quot;Noto Sans&quot;, sans-serif, &quot;Apple Color Emoji&quot;, &quot;Segoe UI Emoji&quot;, &quot;Segoe UI Symbol&quot;, &quot;Noto Color Emoji&quot;;padding-left:0.5rem;padding-right:0.5rem;padding:1.5rem">
      <table  align="center" width="100%" class="" border="0" cellPadding="0" cellSpacing="0" role="presentation" style="max-width:45.5em; padding-top:30px;background-color:white;">
        <tbody>
          <tr style="width:100%">
            <td><img alt="yourOSHC" height="40" src="https://youroshc-frontend.skillprompt.com/assets/logo/Mode=Light.png" style="display:block;outline:none;border:none;text-decoration:none;margin-left:auto;margin-right:auto" width="225.3" />
              <div style="padding-left:1.5rem;padding-right:1.5rem;padding-bottom:2rem;">
              ${
                heading
                  ? `<p class="" style="font-size:30px;line-height:30px;margin:16px 0;text-align:center;font-weight:600;padding-top:0.6rem">${heading}</p>`
                  : ""
              }
             ${
               receiver_name
           ...
           ${
            ...
            <div style="background-color:#ebe134">
            ...
            <p style="margin-left:10px;font-size:0.75rem;line-height:1rem;color:black;text-decoration:none;display:inline-block;">support@youroshc.com.au</p>
            </div>
            <div style="height:36px">
           ...
           <img style="display:inline-block;" src="https://youroshc-dev-sydney-public.s3.ap-southeast-2.amazonaws.com/public/phone.png" />
            ...
            <p style="font-size:1rem;line-height:1.5rem;margin:5px 0px;font-weight:400;text-align:center;color:black">Disclaimer</p>
            <p style="font-size:0.875rem;line-height:1.25rem;margin:5px 0;text-align:left;font-weight:300;color:black"> The content of this email is confidential and intended for the recipient specified in the message only. It is strictly forbidden to share any part of this message with any third party, without the written consent of the sender. If you received this message by mistake, please reply to this message and follow with its deletion, so that we can ensure such a mistake does not occur in the future.</p>
            </div>
            <div style="padding-bottom:6px">
            <p style="background-color:#ebe134;font-size:1rem;line-height:1.5rem; color: black; padding-top:10px;padding-bottom:10px;padding-left:40px;padding-right:20px;border-radius:4px"> YourOSHC deeply values your ongoing support, Thank you.</p>
            </div>
            </div>     
            </div>
            </div>
